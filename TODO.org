...
** TODO NoteOrRest mods:  accents per section (including const per note)
...
** TODO NoteOrRest mods:  dynamics per section
...
** DONE Annotate sections with Note text
